...
#define IS_NIL(a) (a->key == 0 && a->info == 0 && a->red == 0)
#define IS_ROOT(a) (IS_NIL(a->parent))
...
rb_red_blk_node *TreeMin(rb_red_blk_tree*);
rb_red_blk_node *TreeMax(rb_red_blk_tree*);
